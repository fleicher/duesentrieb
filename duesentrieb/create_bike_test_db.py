...
insert_element("topic_bike", "Flip the bike", id=0, add_structure=False)
...
insert_element("topic_bike", "Take the back wheel away from the bike", id=2, add_structure=False)

insert_element("topic_bike", "Remove the front tire", id=3, fronts=4)
insert_element("topic_bike", "take away the front tire", id=3, add_structure=False)

insert_element("topic_bike", "now you are done", id=4, fronts=0)  # 0 is for the final one
